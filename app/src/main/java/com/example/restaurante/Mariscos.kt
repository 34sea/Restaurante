...
import com.example.restaurante.databinding.ActivityMariscosBinding
import com.google.firebase.firestore.FirebaseFirestore

class Mariscos : AppCompatActivity() {

    private lateinit var binding: ActivityMariscosBinding

    private val fr = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMariscosBinding.inflate(layoutInflater)
