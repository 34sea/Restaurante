...
import com.example.restaurante.databinding.ActivitySalgadosBinding
import com.google.firebase.firestore.FirebaseFirestore

class Salgados : AppCompatActivity() {

    private lateinit var binding: ActivitySalgadosBinding

    private val fr = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySalgadosBinding.inflate(layoutInflater)
